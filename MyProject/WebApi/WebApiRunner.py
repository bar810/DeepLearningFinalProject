...
import MyProject.NeuralNetworks.Food_101.src.food_label_predict as foodClassifier
import MyProject.NeuralNetworks.Food_101.src.food_non_food_predict as foodNonFoodClassifier
